...
```
KBEngine 没有 BigWorld 那么完整的 compiled space 体系。
它更偏向：
  - 运行时空间
  - 较薄的世界资产层
```
...
```
theseed 明确把 world streaming / compiled space 放到世界系统层，
不把它混进 runtime Space 定义，
但保留 BigWorld 级工具链边界作为长期方向。
```
