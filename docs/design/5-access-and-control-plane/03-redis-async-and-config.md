...
```
BigWorld 时代没有今天这种“Redis + 异步框架 + 统一配置中心”的完整基础设施栈。
...
```
theseed 选择把 Redis、异步任务和配置中心放进基础设施层，
原因是这些能力会被 runtime、ops、script 三层同时消费。
